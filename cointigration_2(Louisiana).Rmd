...
# Null hypothesis (r = 0) is rejected as 5 pct value (19.96) < test value (26.05). Thus at least one co-integration relationship exist between Rt and air temperature. 
# In the second hypothesis (r=1),value of 5 pct (9.24) > test value(5.05). Therefore there exist at most 2 co-integration relationship. 
...
w = Rt_ts + 0.4305429*RH_ts + -34.5658998
plot(w, type="l")
...
w = Rt_ts - 0.05981001*apple_driving_ts + 9.24969986
plot(w, type="l")
...
w = Rt_ts + 0.08941035*Google_workplace_ts + 0.92367711
plot(w, type="l")
...
w = Rt_ts - 0.5585474*Google_residential_ts + 1.3090219
plot(w, type="l")
